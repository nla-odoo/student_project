odoo.define('owldemo.register', function (require) {
    "use strict";

    require('web.dom_ready');
    if (!$('.registrationform').length) {
        return Promise.reject("DOM doesn't contain '.registrationform'");
    }
    ...
    function setup() {
        ...
        owlRagistartionInstance.mount($('.registrationform')[0]);
    }
